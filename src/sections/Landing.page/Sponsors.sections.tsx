...
// import aptorLogo from "../../assets/logos/sponsors/aptor_logo.svg";
      ...
      <thead class={css({ h: '100%', w: '100%' })}>
        <tr
          class={css({
            ...
            ...flexCenter,
            flexDir: 'row',
            borderRight: props.borderOff ? 'none' : '1px solid black',
          })}
        >
          <For each={props.list}>
            {sponsor => (
              <td
                class={css({
                  ...
                  borderTop: props.borderOff ? 'none' : '1px solid black',
                  borderBottom: props.borderOff ? 'none' : '1px solid black',
                  borderLeft: props.borderOff ? 'none' : '1px solid black',
  ...
  return (
    ...
    >
      ...
      <_LogoRow
        list={supporters}
        // borderOff={true}
        height={{ base: '75px', md: '150px', lg: '175px' }}
        class={css({ mb: '30px' })}
      />
    </section>
  );
